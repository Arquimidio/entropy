...
export default function CurrentSpotify() {
  ...
  if (!presenceData || !presenceData?.listening_to_spotify || !isHeartStopped)
    return null;
    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="flex items-center rounded-md overflow-hidden min-h-[64px]">
        <div className="w-[64px] rounded-md overflow-hidden h-[64px] shrink-0">
          <img
            className="max-w-full w-full h-full aspect-square object-cover"
        ...
        <div className="pl-5 flex-grow flex flex-col gap-1">
          <div className="leading-3">
            <div className="text-sm font-semibold text-slate-600 dark:text-slate-300 line-clamp-1">
