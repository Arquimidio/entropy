...
export default function CurrentSpotify() {
    ...
    return (
        <div className="flex flex-col gap-4">
            ...
            <div className="flex items-center rounded-md overflow-hidden min-h-[96px]">
                ...
                <div className="pl-5 flex-grow flex flex-col gap-1">
                    <div className=" text-slate-600 dark:text-slate-300 line-clamp-1">{presenceData?.spotify?.song}</div>
