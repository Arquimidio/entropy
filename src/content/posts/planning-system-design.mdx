...
After having a solid idea of what is the product's main point, it's time to think about the higher levels of it's system design. Usually there are two main aspects that
have to be taken into account, and these are the **functional** and **non-functional** aspects of the product.
...
to handle creating a and rading a tweet, commenting on it, liking it, etc. 

The idea is to ask ourselves **how do we want the application to function?**, and this is closely related to what's the product main goal. Is it enabling people to communicate to each other with short texts? Is it to provide a highly flexible app where people can create and customize their servers?
...
Now that we know what is necessary to achieve the product's purpose, it's time to think about what is necessary to bring the idea to life
and keep it breathing. Here we try to estimate, based on the product purpose, what hardware and software components will make up the system. 
...
- **Fault Tolerance**: similar to reliability, system tolerance to fails in specific parts
...
### 2. What communication protocol should we use?

Here we will focus on the dilemma on choosing between using HTTP and Websocket protocol. 

### 3. "to SQL or to NoSQL" - Buda, probably
...
### 6. Do we need a message queue system?
