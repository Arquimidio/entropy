...
Now that we know what is necessary to achieve the product's purpose, it's time to think about how to keep the system breathing after bringing it to life. It is related to how well the system will perform. Here we try to estimate, based on the product purpose, what hardware and software components will make up the system, what are the qualities / characteristics
...
![TCP and UDP diagram](./images/tcp-udp.png)
