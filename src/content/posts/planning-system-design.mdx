...
title: Building Bridges That Last
description: What to have in mind when designing a system
---

What does a bridge need? 

1. Stable Foundation to support it's own structure and withstand heavy loads
2. Good Maintenance
3. Backup Safety Systems
4. Environmental Adaptability
5. Connect point A to point B

A well designed system will have characteristics similar to the afromentioned bridge. It should:
